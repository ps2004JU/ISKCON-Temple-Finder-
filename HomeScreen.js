...
"Belagavi (India)":["ISKCON Temple(Sri Sri Radha Gokulananda Temple) - Tilakwadi"],
  ...
  "Port Elizabeth":["ISKCON Temple - 22 Alexander Road"],
...
return (
  <LinearGradient
    colors={['#FFA500', '#FF69B4', '#0000FF']} // Orange, Pink, Blue
    style={styles.container}
  >
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <Text style={styles.title}>Hare Krishna !!!</Text>
      <Text style={styles.subtitle}>
        Find ISKCON (Hare Krishna) Temple in Your City 
      </Text>
      <DropDownPicker
        open={open}
        value={value}
        ...
        setItems={setItems}
        searchable={true}
        placeholder="Select your city(City must be in India, UK, Thailand, NZ, Australia,)"
